...
Accounts.emailTemplates.siteName = 'BPF Payment Gateway';
Accounts.emailTemplates.from = 'BPF Payment Gateway Accounts <accounts@paymentgateway.blockchainphilanthropy.foundation>';

Accounts.emailTemplates.resetPassword = {
  subject() {
    return 'Reset your password on the BPF Payment Gateway';
  },
  text(user, url) {
    return `Hello!

Click the link below to reset your password on the BPF Payment Gateway.
